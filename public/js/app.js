...
var Router = function () {
    function Router() {
        ...
        this.vueInstance = Vue.extend({});
    }

    _createClass(Router, [{
        key: 'vue',
        value: function vue(options) {
            this.vueInstance = Vue.extend(options);
        }
    }, {
        key: 'make',
        value: function make(path, controller) {
            var params = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
            ...
            if (params) {
                for (var item in params) {
                    this.routes[path][item] = params[item];
                }
            }
        ...
        value: function registerMiddleware(name, action) {
            this.middleware[name] = action;
            return this;
        }
    }, {
        key: 'importMiddlewares',
        value: function importMiddlewares(middlewares) {
            this.middleware = middlewares;
            return this;
        }
    }, {
        key: 'callMiddleware',
        value: function callMiddleware(name) {
            return this.middleware[name].call();
        }
    }, {
        key: 'prepareMiddleware',
        value: function prepareMiddleware() {
            var vm = this;
            this.router.beforeEach(function (transition) {
                if (transition.to.middleware) {
                    if (!vm.callMiddleware(transition.to.middleware)) {
                        transition.abort();
                    }
                }
        ...
        key: 'redirect',
        value: function redirect(paths) {
            this.router.redirect(paths);
        }
    }, {
        key: 'setRoutes',
        ...
        value: function start(el) {
            ...
            this.router.map(this.all());
            this.router.start(this.vueInstance, el);
        }
    }]);
...
},{"vue":60,"vue-router":3}],59:[function(require,module,exports){
var Vue // late bind
...
},{"_process":57}],61:[function(require,module,exports){
'use strict';

var _laravuejsRouter = require('laravuejs-router');

var _laravuejsRouter2 = _interopRequireDefault(_laravuejsRouter);
...
_laravuejsRouter2.default.router._linkActiveClass = 'active';

_laravuejsRouter2.default.setRoutes(_routes2.default);
...
exports.default = {
    ...
    methods: {
        getPermissions: function getPermissions() {
            ...
            this.$http.get("/api/v1/permission").then(function (r) {
                _this.permissions = r.data;
            });
        }
    },
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"panel panel-default\">\n    <div class=\"panel-heading\">Permissions</div>\n    <ul class=\"list-group\">\n        <li class=\"list-group-item\" v-for=\"permission in permissions\">\n            {{ permission.name }}\n            <div class=\"pull-right\">\n                <div class=\"label label-info\" style=\"font-weight: 200\">{{ permission.slug }}</div>\n            </div>\n        </li>\n    </ul>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-0f40e27e", module.exports)
  } else {
    hotAPI.update("_v-0f40e27e", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":60,"vue-hot-reload-api":59}],63:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        openNewRoleModal: function openNewRoleModal() {
            $('#newRoleModal').modal('show');
        },
        closeNewRoleModal: function closeNewRoleModal() {
        ...
        getPermissions: function getPermissions() {
            ...
            this.$http.get('/api/v1/permission').then(function (r) {
                _this2.permissions = r.data;
                _this2.$nextTick(function () {
                    this.createSortableAreas();
                });
            });
        },
        detachPermission: function detachPermission(permission, role) {
            this.$http.delete('/api/v1/role/' + role.id + '/permission', { permission: permission.id }).then(function (r) {
        ...
        saveRole: function saveRole(e) {
            ...
            var data = new FormData(e.srcElement);
            this.$http.post('/api/v1/role', data).then(function (r) {
                _this3.roles.push(r.data);
                _this3.closeNewRoleModal();
        ...
        createSortableAreas: function createSortableAreas() {
            var vm = this;
            var areas = document.getElementsByClassName('permission-sort');
            for (var i = 0; i < areas.length; i++) {
                ...
                if (item.getAttribute('data-main') == 'true') {
                    ...
                    var _sortable = new Sortable(item, {
                        animation: 150,
                        sort: false,
                        ...
                        onAdd: function onAdd(e) {
                            var item = e.item;
                            var permission = getItemById(vm.permissions, item.getAttribute('data-id'));
                            var role = getItemById(vm.roles, e.to.getAttribute('data-id'));
                            console.log('you drop me', permission, role);
                            vm.$http.patch('/api/v1/role/' + role.id + '/attach-permission', { permission: permission.id }).then(function (r) {
...
function getItemById(object, id) {
    ...
    try {
        for (var _iterator = (0, _getIterator3.default)(object), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-57d28712", module.exports)
  } else {
    hotAPI.update("_v-57d28712", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _index = require("./controllers/RolesController/index.vue");

var _index2 = _interopRequireDefault(_index);

var _index3 = require("./controllers/PermissionsController/index.vue");
