...
new Vue({
    ...
    methods: {
        ...
        saveRole: function saveRole(e) {
            ...
            console.log(data);
            this.$http.post('/dashboard/role', data).then(function (r) {
                console.log(r.data);
                _this.roles.push(r.data);
                _this.closeNewRoleModal();
            }).catch(function (e) {
                alert(e);
            });
        },
        getRoles: function getRoles() {
            ...
            this.$http.get('/dashboard/role/get').then(function (r) {
                console.log(r.data);
                _this2.roles = r.data;
        ...
        getPermissions: function getPermissions() {
            ...
            this.$http.get('/dashboard/permission/get').then(function (r) {
                console.log(r.data);
                _this3.permissions = r.data;
            }).catch(function (e) {
                alert(e);
            });
        },
...
},{"sortablejs":1,"vue":4,"vue-resource":2}]},{},[5]);
